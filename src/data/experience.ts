...
export const experience: ExperienceEntry[] = [
  {
    ...
    location: 'REMOTE',
    summary:
      "Jayret is a tech partnership built around one goal — giving small businesses access to software that actually works for them. I'm currently leading the development of a platform for a medical transportation company, building them a web presence and opening up private-sector client access they didn't have before. It's early-stage, real-stakes work, and I'm the one driving it.",
    logo: 'jayret.png',
  },
  {
    period: '[2026]',
